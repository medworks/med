...
function GetStringDay($LatinDay)
{
if($LatinDay=="Saturday") return "شنبه";
else if($LatinDay=="Sunday") return "يكشنبه";
else if($LatinDay=="Monday")  return "دوشنبه";
else if($LatinDay=="Tuesday") return "سه شنبه";
else if($LatinDay=="Wednesday") return "چهارشنبه";
else if($LatinDay=="Thursday") return "پنجشنبه";
else if($LatinDay=="Friday") return "جمعه";
}
?>