...
tinymce.init({
            ...
            plugins : 'advlist autolink link image lists charmap print preview code image table searchreplace',
            toolbar: "undo redo | styleselect | bold italic | link image | hr | charmap | preview",
         });
