...
<div class="sidebar">
	...
	<div class="social simple-box">
		<ul>
			...
			<li>
				<a href="http://<?php echo $facebook; ?>" target="_blank" class="facebook"></a>
			</li>
			<li>
				<a href="http://<?php echo $twitter; ?>" target="_blank" class="twitter"></a>
			</li>
			<li>
				<a href="#" class="vimeo"></a>
			</li>
			<li>
				<a href="http://<?php echo $youtube; ?>" target="_blank" class="youtube"></a>
			</li>
			<li>
